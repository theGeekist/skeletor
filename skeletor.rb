class Skeletor < Formula
  ...
  url "https://github.com/jasonnathan/skeletor/releases/download/v2.2.7/skeletor-macos-latest-x86_64-apple-darwin.tar.gz" # link to your tar.gz binary.gz" # link to your tar.gz binary
